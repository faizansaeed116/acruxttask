/**
 * Author and copyright: Munir Tariq (https://)
 * Repository: 
 * License: 
 */
    ...
    $.fn.InputObjectSpinner = $.fn.InputObjectSpinner = function (action, options) {
        ...
        this.each(function () {
            ...
            function getNextItem(e) {
                ...
                if (selected_index < 0) {
                    // selected_index = 0;
                    selected_index = _default_index || 0;
                }
            ...
            function updateSelectedItem(e) {
                ...
                if (typeof selected == "undefined") {
                    console.log("Selected Value Not Found. Selected Object Is: ", selected);
                    console.log("Selected Value Not Found. Selected Index: ", selected_index);
            ...
            function renderSelected(e) {
                ...
                parentElement.children(`#` + name + `-` + current_timestamp).removeClass("bg-grey-300 bg-orange-300 bg-success bg-danger").addClass(selected.color_class);
            }
